...
namespace NeuroPilot.Actions
{
    public class EvadeAction : NeuroAction<string>
    {
        ...
        protected override string Description => "Immediately maneuver the ship to try to avoid or evade the target object, aborting the current autopilot procedure.";
